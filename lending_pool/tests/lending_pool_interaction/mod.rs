...
use crate::{
    constants::{
        ACCOUNT_TOKEN, MOAX_TOKEN_ID, LIQ_THRESOLD, RESERVE_FACTOR, R_BASE, R_SLOPE1, R_SLOPE2,
    ...
    PriceAggregatorObjBuilder: 'static + Copy + Fn() -> aggregator_mock::ContractObj<DebugApi>,
{
    ...
    pub liquidity_pool_moax_wrapper:
        ContractObjWrapper<liquidity_pool::ContractObj<DebugApi>, LiquidityPoolObjBuilder>,
}
    ...
    PriceAggregatorObjBuilder: 'static + Copy + Fn() -> aggregator_mock::ContractObj<DebugApi>,
{
    ...
    pub fn deploy_lending(
        ...
        let liquidity_pool_moax_wrapper = b_mock.create_sc_account(
            &rust_biguint!(0u64),
            Some(&lending_pool_wrapper.address_ref()),
            liquidity_pool_builder,
            "liq_pool_template_other",
        ...
        b_mock
            .execute_tx(
                &owner_addr,
                &liquidity_pool_moax_wrapper,
                &rust_biguint!(0),
                |sc| {
                    sc.init(
                        managed_token_id!(MOAX_TOKEN_ID),
                        managed_biguint!(R_BASE),
                        managed_biguint!(R_SLOPE1),
                        managed_biguint!(R_SLOPE2),
                        managed_biguint!(U_OPTIMAL),
        ...
        b_mock
            .execute_tx(
                ...
                |sc| {
                    sc.pools_map().insert(
                        managed_token_id!(MOAX_TOKEN_ID),
                        managed_address!(&liquidity_pool_moax_wrapper.address_ref()),
                    );
                    sc.pools_allowed()
                        .insert(managed_address!(&liquidity_pool_moax_wrapper.address_ref()));
        ...
        Self {
            ...
            liquidity_pool_moax_wrapper: liquidity_pool_moax_wrapper,
        }
    }
    ...
    pub fn add_collateral(
        ...
        let liquidity_pool_wrapper = match token_id {
            ...
            MOAX_TOKEN_ID => &self.liquidity_pool_moax_wrapper,
            _ => todo!(),
        };
        ...
        self.b_mock
            .execute_query(&liquidity_pool_wrapper, |sc| {
                ...
                let expected_collateral = dharitri_sc::types::BigUint::from_bytes_be(
    ...
    pub fn borrow(
        ...
        self.b_mock
            .execute_query(&liquidity_pool_wrapper, |sc| {
                ...
                let expected_borrowed = dharitri_sc::types::BigUint::from_bytes_be(
