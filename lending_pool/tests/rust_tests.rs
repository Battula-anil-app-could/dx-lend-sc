...
fn deposit_test() {
    ...
    lending_setup
        .b_mock
        .set_dct_balance(&user_addr, USDC_TOKEN_ID, &rust_biguint!(1_000));
...
fn liquidate_test() {
    ...
    lending_setup
        .b_mock
        .set_dct_balance(&liquidatee_user, USDC_TOKEN_ID, &rust_biguint!(1_000));
    ...
    lending_setup
        .b_mock
        .set_dct_balance(&liquidator_user, USDC_TOKEN_ID, &rust_biguint!(300));
...
//     lending_setup
//         .b_mock
//         .set_dct_balance(&user_addr, USDC_TOKEN_ID, &rust_biguint!(2_000 * BP));
...
//     lending_setup
//         .b_mock
//         .set_nft_balance(&user_addr, LEND_MOAX, 1, &rust_biguint!(10 * BP), &Empty);
...
//     lending_setup
//         .b_mock
//         .set_nft_balance(&user_addr, LEND_MOAX, 2, &rust_biguint!(10 * BP), &Empty);
...
//     payments.push(TxInputDCT {
//         token_identifier: LEND_MOAX.to_vec(),
//         nonce: 2,
...
//     lending_setup
//         .b_mock
//         .set_dct_balance(&borrower_addr, USDC_TOKEN_ID, &rust_biguint!(200_000));
...
//     lending_setup
//         .b_mock
//         .set_dct_balance(&borrower_addr, MOAX_TOKEN_ID, &rust_biguint!(1_000));
...
//         .execute_dct_transfer(
//             &borrower_addr,
//             &lending_setup.liquidity_pool_moax_wrapper,
//             MOAX_TOKEN_ID,
//             0,
//             &rust_biguint!(1_000),
//             |sc| {
...
//                     managed_biguint!(MOAX_PRICE_DROPPED_IN_DOLLARS),
//                 );
//             },
//         )
//         .assert_ok();
...
//     lending_setup
//         .b_mock
//         .set_dct_balance(&liquidator_addr, USDC_TOKEN_ID, &rust_biguint!(100_000));
...
//     // Check Liquidator Balance - LEND_MOAX tokens
//     lending_setup.b_mock.check_nft_balance(
//         &liquidator_addr,
//         LEND_MOAX,
//         1,
...
//     // Supply/Deposit
//     lending_setup.b_mock.set_dct_balance(
//         &supplier_addr,
//         USDC_TOKEN_ID,
//         &rust_biguint!(2_000 * BP),
//     );
...
//     lending_setup
//         .b_mock
//         .check_dct_balance(&borrower_addr, USDC_TOKEN_ID, &rust_biguint!(0));
...
//     lending_setup
//         .b_mock
//         .set_dct_balance(&borrower_addr, USDC_TOKEN_ID, &rust_biguint!(630 * BP));
...
//     lending_setup
//         .b_mock
//         .set_dct_balance(&borrower_addr, USDC_TOKEN_ID, &rust_biguint!(412 * BP));
...
//     lending_setup
//         .b_mock
//         .set_dct_balance(&alice_addr, USDC_TOKEN_ID, &rust_biguint!(40_000 * BP));
...
//     lending_setup
//         .b_mock
//         .set_dct_balance(&bob_addr, USDC_TOKEN_ID, &rust_biguint!(20_000 * BP));
...
//     lending_setup
//         .b_mock
//         .set_nft_balance(&dave_addr, LEND_MOAX, 4, &rust_biguint!(60 * BP), &Empty);
...
//     lending_setup
//         .b_mock
//         .set_nft_balance(&eve_addr, LEND_MOAX, 5, &rust_biguint!(120 * BP), &Empty);
...
//     lending_setup
//         .b_mock
//         .set_dct_balance(&eve_addr, USDC_TOKEN_ID, &rust_biguint!(12_660 * BP));
...
//     lending_setup
//         .b_mock
//         .check_dct_balance(&eve_addr, USDC_TOKEN_ID, &rust_biguint!(0));
...
//     lending_setup
//         .b_mock
//         .check_dct_balance(&dave_addr, USDC_TOKEN_ID, &rust_biguint!(0));
...
//     lending_setup
//         .b_mock
//         .check_dct_balance(&charlie_addr, USDC_TOKEN_ID, &rust_biguint!(0));
...
//     lending_setup
//         .b_mock
//         .check_dct_balance(&borrower2_addr, USDC_TOKEN_ID, &rust_biguint!(0));
