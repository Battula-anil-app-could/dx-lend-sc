...
pub const MOAX_TICKER: &[u8] = b"WMOAX";
pub const MOAX_TOKEN_ID: &[u8] = b"WMOAX-123456";
pub const MOAX_PRICE_IN_DOLLARS: u64 = 20_000; // $200
pub const MOAX_PRICE_DROPPED_IN_DOLLARS: u64 = 14_000; // $140
