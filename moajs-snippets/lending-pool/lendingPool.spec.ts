...
describe("lending snippet", async function () {
    ...
    it("withdraw token XYZ", async function () {
        ...
        let paymentXYZ = TokenPayment.metaDctFromAmount(lendTokenXYZ, depositNonceXYZ, 7, tokenXYZ.decimals)
    ...
    it("borrow ABC token - collateral XYZ", async function () {
        ...
        let collateralPayment = TokenPayment.metaDctFromAmount(lendTokenXYZ, depositNonceXYZ, 5, tokenXYZ.decimals)
    ...
    it("repay ABC token - collateral XYZ", async function () {
        ...
        let paymentOne = TokenPayment.metaDctFromAmount(borrowedTokenABC, borrowedNonceABC, 3.21, tokenXYZ.decimals);
